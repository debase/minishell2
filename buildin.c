...
** Last update Thu Mar  7 04:17:42 2013 etienne debas
*/
...
{
  if (my_strcmp2(argv[0], "cd") == 1 ||
      my_strcmp2(argv[0], "chdir") == 1)
    {
      change_dir(argv, sct);
      return (1);
    }
  else if (my_strcmp2(argv[0], "exit") == 1)
    my_exit(sct);
  else if (my_strcmp2(argv[0], "setenv") == 1)
    {
      my_setenv(sct, argv);
      return (1);
    }
  else if (my_strcmp2(argv[0], "unsetenv") == 1)
    {
      my_unsetenv(sct, argv);
      return (1);
    }
  else if (my_strcmp2(argv[0], "env") == 1)
    {
      env(sct, argv);
      return (1);
    }
