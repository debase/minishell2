...
** Last update Sun Mar 10 12:12:29 2013 etienne debas
*/
...
int		choose_exec_pipe(t_pipe *, int *, t_list *, int *);
...
void		fill_function_tab(int (*[])(t_list *, char **), char **);
int		source_alias(t_list *, char **);
